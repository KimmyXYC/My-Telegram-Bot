...
async def handle_xiatou(bot, message, count):
    if message.content_type == 'text':
        ...
        if text_content is None:
            return False
    pattern = r"(?:舔|嗦|啃|舔舐|舔舔|舔舐|吻|嘬)(?:(?:萝莉|幼女|云漓|克拉拉|小格雷修|小女孩)(?:的)?(?:脚|jio|足|狱卒|嫩足|脚丫子|脚丫|脚趾头|玉足|裸足))|(?:萝莉|幼女|云漓|克拉拉|小格雷修)\s*(?:脚|jio|足|狱卒|嫩足|脚丫子|脚丫|脚趾头|玉足|裸足)\s*(?:给我|放进|想|感觉|看着)|(?:jio|脚|狱卒|玉足|足|脚丫|脚丫子|脚趾|脚趾头|嫩足|裸足|小脚|小足|脚板|脚掌|脚背|足尖|脚丫丫)(?!满足|脚本)"
